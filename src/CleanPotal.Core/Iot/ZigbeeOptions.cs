...
public sealed class ZigbeeOptions
{
    ...
    /// <summary>
    /// 주기 기록(IsSnapshot) 줄을 며칠 동안 남길지. 0 이면 지우지 않는다. 실제 수신 줄은 이 설정과 관계없이 남는다.
    /// 주기 기록은 센서마다 1분에 한 줄이라 센서 4개면 한 해 약 200만 줄이다(SQL Server Express 10GB).
    /// 기본 365일 — 1년이 지난 구간은 실제 수신 줄만으로 그래프를 그린다.
    /// </summary>
